...
train_clean <- select(train_clean, -RoofStyle, -BldgType, -LandSlope, -LotConfig, -LandContour, -LotShape, -CentralAir, -Heating, -ExterCond, -RoofMatl, -HouseStyle, -Condition1, -Condition2, -Street)
```
...
train_to_process_categorical <- select(train, MasVnrArea, GarageYrBlt, MasVnrType, GarageType, GarageFinish, GarageQual, GarageCond, BsmtQual, BsmtCond, BsmtExposure, BsmtFinType1, BsmtFinType1, BsmtFinType2, Electrical, MSZoning, Utilities, Exterior1st, Exterior2nd, KitchenQual, Functional, SaleType)
```
...
train_final <- cbind(select(train_to_process, -Utilities, -Functional, -BsmtFinType2, -BsmtFinSF2, -BsmtHalfBath, -GarageCond, -GarageQual, -BsmtCond, -Electrical,  -MSZoning, -SalePrice), train_clean)
```
...
test_clean <- select(test_clean, -RoofStyle, -BldgType, -LandSlope, -LotConfig, -LandContour, -LotShape, -CentralAir, -Heating, -ExterCond, -RoofMatl, -HouseStyle, -Condition1, -Condition2, -Street)
...
test_final <- cbind(select(test_to_process, -Utilities, -Functional, -BsmtFinType2, -BsmtFinSF2, -BsmtHalfBath, -GarageCond, -GarageQual, -BsmtCond, -Electrical,  -MSZoning), test_clean)
```
